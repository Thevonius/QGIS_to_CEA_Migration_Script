...
def run_from_qgis():
    ...
    try:
        ...
        print("Copy zone.shp & site.shp to CEA: inputs/building-geometry/")
        print("Copy typology.dbf to CEA: inputs/building-properties/")
        return result
...
if __name__ == '__main__':
    ...
    print("Load in QGIS Python Console and call run_from_qgis()")
    print("Or: selected_features_to_cea(r'C:\\output\\folder')")
